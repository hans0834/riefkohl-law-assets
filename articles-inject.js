// Riefkohl Law — Trust Law Article Series (14 articles)
// Loaded externally via GitHub Pages

// Inject article CSS
(function(){
var s=document.createElement('style');
s.id='rl-articles-extra';
s.textContent=`/* Callout box for articles */
.rl-sub .rl-callout {
  background: #f8f6f0;
...
'/resources/what-is-puerto-rico-trust': {
  ...
  +'<li><a href="/resources/asset-protection-trusts">Article 6: Asset Protection Trusts Under the PR Trust Act</a></li>'
  ...
  +'<li><a href="/resources/ilits-slats-advanced-planning">Article 8: ILITs and SLATs: Advanced Trust Planning for Puerto Rico Residents</a></li>'
  +'<li><a href="/resources/trust-taxation">Article 9: Trust Taxation: A Historical and Current Perspective (PR and US)</a></li>'
  +'<li><a href="/resources/landmark-trust-cases">Article 10: Landmark Puerto Rico Trust Cases You Should Know</a></li>'
  +'<li><a href="/resources/trust-costs">Article 11: The Costs of Creating, Administering, and Terminating a Trust in Puerto Rico</a></li>'
  +'<li><a href="/resources/fiduciary-duties">Article 12: Fiduciary Duties Under Puerto Rico Trust Law</a></li>'
...
'/resources/modifying-irrevocable-trusts': {
  ...
  +'<li><a href="/resources/avoiding-probate-legitima">Article 5: Avoiding Probate in Puerto Rico: Trusts and the Leg\u00edtima</a></li>'
  +'<li><a href="/resources/asset-protection-trusts">Article 6: Asset Protection Trusts Under the PR Trust Act</a></li>'
  +'<li><a href="/resources/trust-taxation">Article 9: Trust Taxation: A Historical and Current Perspective</a></li>'
  +'</ul>'
...
'/resources/avoiding-probate-legitima': {
  ...
  +'<h3>Other Articles in This Series</h3>'
  +'<ul>'
  +'<li><a href="/resources/complete-guide-puerto-rico-trusts">What Is a Puerto Rico Trust?</a></li>'
  +'<li><a href="/resources/asset-protection-irrevocable-trusts">How Modifiable Are Puerto Rico\u2019s Irrevocable Trusts?</a></li>'
...
'/resources/asset-protection-trusts-pr': {
  ...
  +'<h3>Related Articles in This Series</h3>'
  +'<ul>'
  +'<li><a href="/resources/complete-guide-puerto-rico-trusts">Introduction to Puerto Rico Trust Law</a></li>'
...
'/resources/ilits-and-slats': {
  ...
  +'<li><a href="/resources/pr-trust-framework">The Puerto Rico Trust Framework: Autonomous Estates and Irrevocability</a></li>'
  +'<li><a href="/resources/asset-protection">Asset Protection Strategies Under PR Law</a></li>'
  +'<li><a href="/resources/directed-trusts">Directed Trusts and Investment Control</a></li>'
  +'</ul>'
...
'/resources/trust-costs-puerto-rico': {
  ...
  +'<p>As covered in <a href="/resources/trust-dispute-resolution">Article 9 of this series</a>, Puerto Rico trusts can incorporate arbitration provisions, yielding substantial cost savings when disputes arise.</p>'
  ...
  +'<h2>Related Articles in This Series</h2>'
  +'<ul>'
  +'<li><a href="/resources/trust-modification-decanting">Article 10: Trust Modification and Decanting</a></li>'
...
var SERIES_NAV = '<div class="rl-series-nav">'
...
function injectArticleHub() {
  ...
  var html = '<div class="rl-article-hub" style="max-width:1140px;margin:48px auto 12px;padding:0 28px;">'
    ...
    + '<p style="color:rgba(255,255,255,.55);font-size:.92rem;max-width:560px;margin:0 auto;">A 13-part practitioner-grade series covering everything from trust fundamentals to advanced tax planning. Written by Hans Riefkohl for investors who want to understand the law, not just follow instructions.</p>'
    + '</div>';
  ...
  categories.forEach(function(cat) {
    ...
    html += '</div><div style="max-width:1140px;margin:0 auto;padding:0 28px;">';
  });
